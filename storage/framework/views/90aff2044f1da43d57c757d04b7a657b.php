...
<form action='<?php echo e(url('super_admin/'.$user->id)); ?>' method='post'>
<?php echo csrf_field(); ?>
<?php echo method_field('PUT'); ?>
    <div class="my-3 p-3 bg-body rounded shadow-sm">    
        <a href="<?php echo e(url('super_admin')); ?>" class="btn btn-secondary">Kembali</a>
        <div class="mb-3 row">
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\NENAY\ticketing\resources\views/super_admin/edit.blade.php ENDPATH**/ ?>